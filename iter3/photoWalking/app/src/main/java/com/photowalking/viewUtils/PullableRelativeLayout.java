...
public class PullableRelativeLayout extends RelativeLayout {
    ...
    public static final String TAG = "PullableRelativeLayout";
    // 初始状态
    ...
    // 释放刷新的距离
    private float refreshDist = 60;
    // 释放加载的距离
    private float loadmoreDist = 60;
            ...
            AsyncTask<Integer, Float, String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(PullableRelativeLayout.this);
            hide();
        }
    ...
    public interface OnRefreshListener
    {
         ...
         * 刷新操作
         */
        void onRefresh(PullableRelativeLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullableRelativeLayout pullToRefreshLayout);
    }
}
