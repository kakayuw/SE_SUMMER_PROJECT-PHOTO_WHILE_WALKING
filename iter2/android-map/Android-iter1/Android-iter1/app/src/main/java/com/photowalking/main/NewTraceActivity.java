...
public class NewTraceActivity extends AppCompatActivity {
    ...
    @Bind(R.id.btn_StartCamera) Button _beginCamera;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Toast.makeText(NewTraceActivity.this, "Touched id " +id , Toast.LENGTH_SHORT).show();
...
/*        if (id == R.id.action_github) {
    ...
    FilterMenu.OnMenuChangeListener listener = new FilterMenu.OnMenuChangeListener() {
        ...
        public void onMenuItemClick(View view, int position) {
            Toast.makeText(NewTraceActivity.this, "Touched position " + position, Toast.LENGTH_SHORT).show();
        ...
        public void onMenuExpand() {
            Toast.makeText(NewTraceActivity.this, "Touched position " , Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private void inputTitleDialog() {
        ...
        builder.setTitle("请输入路线名").setIcon(
                R.drawable.huaji).setView(inputServer).setNegativeButton(
                "取消", null);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(getApplicationContext(),FragmentsActity.class);
